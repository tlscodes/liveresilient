...
void main() {
  ...
  group('4a the linked module reached a peer that offers the extension', () {
    test('4a the recorded probe answered applied, on a real device', () {
      expect(
        _peerHonouredTheConfiguration(fields),
        isTrue,
    ...
    test(
      '4a the peer offered a public name different from the one asked for',
      () {
        ...
        expect(
          ...
          isNot(equals(public)),
          reason:
              'if the two names are the same there is nothing for the '
        ...
        expect(
          ...
          contains(':'),
          reason:
              'the address the device actually reached is part of the '
    ...
    test('4a the predicate rejects a finished exchange the peer ignored', () {
      ...
      expect(
        _peerHonouredTheConfiguration(const {}),
        isFalse,
